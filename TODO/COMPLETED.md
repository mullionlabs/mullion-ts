...
| ------ | ---------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| **19** | 2026-02-09 | **Runtime Model Catalog + Pricing Refresh** | Runtime model/pricing/capability catalog overrides, GPT-5 baseline refresh, deterministic catalog tooling, docs, and integration validation across providers.       | [→](./tasks/19-runtime-catalog-and-pricing-refresh.md) |
