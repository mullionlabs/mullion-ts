...
### 0.1 Initial Setup
- [ ] Run `pnpm install`
- [ ] Run `pnpm build` (expect empty dist folders)
- [ ] Run `pnpm typecheck`
- [ ] Verify Turborepo caching works: run `pnpm build` again (should be cached)
...
- [ ] Add all required fields: value, confidence, __scope, traceId
